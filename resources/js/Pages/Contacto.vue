              ...
              <form @submit.prevent="sendMessage">
                ...
                <div class="mb-4">
                  ...
                  <textarea v-model="form.message" id="message"
                    class="mt-1 p-2 w-full border border-gray-300 rounded-md" required></textarea>
                </div>
                <div>
                  <button type="submit"
                    class="w-full bg-indigo-600 text-white py-2 px-4 rounded-md hover:bg-indigo-700">Enviar</button>
                </div>
              </form>
            </div>
            <!-- Mapa -->
